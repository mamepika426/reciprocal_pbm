...
class ClickSimulationFeed(BaseInputFeed):
    ...
    def get_batch(self, data_set, check_validation=False, data_format = "ULTRA"):
        ...
        # print("batch_docid_inputs.shape: ", len(batch_docid_inputs), batch_docid_inputs[0].shape)
        input_feed = {}
        ...
        # print("letor_features_neme: ", input_feed[self.model.letor_features_name])
        # print("letor_features_neme.shape: ", input_feed[self.model.letor_features_name].shape)
