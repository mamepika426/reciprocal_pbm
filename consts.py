...
S = 10
NUM_SHEETS_M2F = 1000  # 男性から女性に送信したメッセージについてのログの総数
NUM_SHEETS_F2M = 500  # 女性から男性に送信したメッセージについてのログの総数

NUM_TRAIN_SHEETS_M2F = 800 # トレーニングに回すシート枚数(男性から女性に送信したメッセージについてのログ)
NUM_TRAIN_SHEETS_F2M = 400 # トレーニングに回すシート枚数(女性から男性に送信したメッセージについてのログ)
